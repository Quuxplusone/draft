...
namespace std {
  ...
  template<class Key, class T, class Compare = less<Key>, class Allocator = allocator<byte>>
    flat_map(initializer_list<pair<Key, T>>, Compare = Compare(), Allocator = Allocator())
...
namespace std {
  ...
  template<class Key, class T, class Compare = less<Key>, class Allocator = allocator<byte>>
    flat_multimap(initializer_list<pair<Key, T>>, Compare = Compare(), Allocator = Allocator())
...
namespace std {
  ...
  template<class Key, class Compare = less<Key>, class Allocator = allocator<byte>>
    flat_set(initializer_list<Key>, Compare = Compare(), Allocator = Allocator())
