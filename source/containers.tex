...
\pnum
The following exposition-only alias template may appear in deduction guides
  ...
  template<class InputIterator, class Allocator>
    queue(InputIterator, InputIterator, Allocator)
      -> queue<@\exposid{iter-value-type}@<InputIterator>, deque<@\exposid{iter-value-type}@<InputIterator>,
               @\exposid{alloc-rebind}@<Allocator, @\exposid{iter-value-type}@<InputIterator>>>>;
  ...
  template<class InputIterator, class Allocator>
    priority_queue(InputIterator, InputIterator, Allocator)
      -> priority_queue<@\exposid{iter-value-type}@<InputIterator>,
                        vector<@\exposid{iter-value-type}@<InputIterator>,
                               @\exposid{alloc-rebind}@<Allocator, @\exposid{iter-value-type}@<InputIterator>>>,
...
namespace std {
  ...
  public:
    ...
    flat_map(const key_compare& comp, key_container_type key_cont,
             mapped_container_type mapped_cont);
    flat_map(sorted_unique_t, const key_compare& comp, key_container_type key_cont,
             mapped_container_type mapped_cont);
    ...
    flat_map(const key_compare& comp, initializer_list<value_type> il)
        : flat_map(il.begin(), il.end(), comp) { }
    flat_map(sorted_unique_t s, initializer_list<value_type> il)
        : flat_map(s, il.begin(), il.end()) { }
    flat_map(sorted_unique_t s, const key_compare& comp, initializer_list<value_type> il)
    ...
    template<class Alloc>
      flat_map(const key_compare& comp, const key_container_type& key_cont,
               const mapped_container_type& mapped_cont, const Alloc& a);
    template<class Alloc>
      flat_map(const key_compare& comp, const key_container_type& key_cont,
               mapped_container_type&& mapped_cont, const Alloc& a);
    ...
    template<class Alloc>
      flat_map(const key_compare& comp, key_container_type&& key_cont,
               mapped_container_type&& mapped_cont, const Alloc& a);
    template<class Alloc>
      flat_map(sorted_unique_t, const key_compare& comp, const key_container_type& key_cont,
               const mapped_container_type& mapped_cont, const Alloc& a);
    template<class Alloc>
      flat_map(sorted_unique_t, const key_compare& comp, const key_container_type& key_cont,
               mapped_container_type&& mapped_cont, const Alloc& a);
    ...
    template<class Alloc>
      flat_map(const key_compare& comp, initializer_list<value_type> il, const Alloc& a);
    template<class Alloc>
      flat_map(sorted_unique_t, initializer_list<value_type> il, const Alloc& a);
    template<class Alloc>
      flat_map(sorted_unique_t, const key_compare& comp,
               initializer_list<value_type> il, const Alloc& a);
  ...
  template<class Compare, class KeyContainer, class MappedContainer>
    flat_map(Compare, KeyContainer, MappedContainer)
      -> flat_map<typename KeyContainer::value_type, typename MappedContainer::value_type,
                  Compare, KeyContainer, MappedContainer>;

  template<class Compare, class KeyContainer, class MappedContainer, class Allocator>
    flat_map(Compare, KeyContainer, MappedContainer, Allocator)
      -> flat_map<typename KeyContainer::value_type, typename MappedContainer::value_type,
                  Compare, KeyContainer, MappedContainer>;

  template<class Compare, class KeyContainer, class MappedContainer>
    flat_map(sorted_unique_t, Compare, KeyContainer, MappedContainer)
      -> flat_map<typename KeyContainer::value_type, typename MappedContainer::value_type,
                  Compare, KeyContainer, MappedContainer>;

  template<class Compare, class KeyContainer, class MappedContainer, class Allocator>
    flat_map(sorted_unique_t, Compare, KeyContainer, MappedContainer, Allocator)
      -> flat_map<typename KeyContainer::value_type, typename MappedContainer::value_type,
                  Compare, KeyContainer, MappedContainer>;
  ...
  template<class InputIterator, class Compare = less<@\exposid{iter-key-type}@<InputIterator>>,
    ...
    flat_map(InputIterator, InputIterator, Compare = Compare(), Allocator = Allocator())
      -> flat_map<@\exposid{iter-key-type}@<InputIterator>, @\exposid{iter-mapped-type}@<InputIterator>, Compare,
                  vector<@\exposid{iter-key-type}@<InputIterator>,
                         @\exposid{alloc-rebind}@<Allocator, @\exposid{iter-key-type}@<InputIterator>>>,
                  vector<@\exposid{iter-mapped-type}@<InputIterator>,
                         @\exposid{alloc-rebind}@<Allocator, @\exposid{iter-mapped-type}@<InputIterator>>>>;

  template<class InputIterator, class Allocator>
    flat_map(InputIterator, InputIterator, Allocator)
      -> flat_map<@\exposid{iter-key-type}@<InputIterator>, @\exposid{iter-mapped-type}@<InputIterator>,
                  less<@\exposid{iter-key-type}@<InputIterator>>,
                  vector<@\exposid{iter-key-type}@<InputIterator>,
                         @\exposid{alloc-rebind}@<Allocator, @\exposid{iter-key-type}@<InputIterator>>>,
                  vector<@\exposid{iter-mapped-type}@<InputIterator>,
                         @\exposid{alloc-rebind}@<Allocator, @\exposid{iter-mapped-type}@<InputIterator>>>>;
  ...
  template<class Key, class T, class Allocator = allocator<byte>>
    flat_map(initializer_list<pair<Key, T>>, Allocator = Allocator())
      -> flat_map<Key, T, less<Key>, vector<Key, @\exposid{alloc-rebind}@<Allocator, Key>>,
                  vector<T, @\exposid{alloc-rebind}@<Allocator, T>>>;

  template<class Key, class T, class Compare, class Allocator = allocator<byte>>
    flat_map(Compare, initializer_list<pair<Key, T>>, Allocator = Allocator())
      -> flat_map<Key, T, Compare, vector<Key, @\exposid{alloc-rebind}@<Allocator, Key>>,
                  vector<T, @\exposid{alloc-rebind}@<Allocator, T>>>;

  template<class Key, class T, class Allocator = allocator<byte>>
    flat_map(sorted_unique_t, initializer_list<pair<Key, T>>, Allocator = Allocator())
      -> flat_map<Key, T, less<Key>, vector<Key, @\exposid{alloc-rebind}@<Allocator, Key>>,
                  vector<T, @\exposid{alloc-rebind}@<Allocator, T>>>;

  template<class Key, class T, class Compare, class Allocator = allocator<byte>>
    flat_map(sorted_unique_t, Compare, initializer_list<pair<Key, T>>,
             Allocator = Allocator())
      -> flat_map<Key, T, Compare, vector<Key, @\exposid{alloc-rebind}@<Allocator, Key>>,
                  vector<T, @\exposid{alloc-rebind}@<Allocator, T>>>;
...
value-initializes \tcode{compare} or
initializes \tcode{compare} with \tcode{comp}, respectively;
...
namespace std {
  ...
  public:
    ...
    flat_multimap(const key_compare& comp, key_container_type key_cont,
                  mapped_container_type mapped_cont);
    flat_multimap(sorted_equivalent_t, const key_compare& comp,
                  key_container_type key_cont, mapped_container_type mapped_cont);
    ...
    flat_multimap(initializer_list<value_type> il)
        : flat_multimap(il.begin(), il.end()) { }
    flat_multimap(const key_compare& comp, initializer_list<value_type> il)
        : flat_multimap(il.begin(), il.end(), comp) { }
    flat_multimap(sorted_equivalent_t s, initializer_list<value_type> il)
        : flat_multimap(s, il.begin(), il.end()) { }
    flat_multimap(sorted_equivalent_t s, const key_compare& comp,
    ...
    template<class Alloc>
      flat_multimap(const key_container_type& key_cont, const mapped_container_type& mapped_cont,
                    const Alloc& a);
    template<class Alloc>
      flat_multimap(const key_container_type& key_cont, mapped_container_type&& mapped_cont,
                    const Alloc& a);
    template<class Alloc>
      flat_multimap(key_container_type&& key_cont, const mapped_container_type& mapped_cont,
                    const Alloc& a);
    template<class Alloc>
      flat_multimap(key_container_type&& key_cont, mapped_container_type&& mapped_cont,
                    const Alloc& a);
    ...
    template<class Alloc>
      flat_multimap(const key_compare& comp, const key_container_type& key_cont,
                    const mapped_container_type& mapped_cont, const Alloc& a);
    template<class Alloc>
      flat_multimap(const key_compare& comp, const key_container_type& key_cont,
                    mapped_container_type&& mapped_cont, const Alloc& a);
    ...
    template<class Alloc>
      flat_multimap(sorted_equivalent_t, const key_compare& comp,
                    ...
                    mapped_container_type&& mapped_cont, const Alloc& a);
    template<class Alloc>
      flat_multimap(sorted_equivalent_t, const key_compare& comp, key_container_type&& key_cont,
                    const mapped_container_type& mapped_cont, const Alloc& a);
    template<class Alloc>
      flat_multimap(sorted_equivalent_t, const key_compare& comp, key_container_type&& key_cont,
                   mapped_container_type&& mapped_cont, const Alloc& a);
  ...
  template<class Compare, class KeyContainer, class MappedContainer>
    flat_multimap(Compare, KeyContainer, MappedContainer)
      -> flat_multimap<typename KeyContainer::value_type, typename MappedContainer::value_type,
                       Compare, KeyContainer, MappedContainer>;

  template<class Compare, class KeyContainer, class MappedContainer, class Allocator>
    flat_multimap(Compare, KeyContainer, MappedContainer, Allocator)
      -> flat_multimap<typename KeyContainer::value_type, typename MappedContainer::value_type,
                       Compare, KeyContainer, MappedContainer>;

  template<class Compare, class KeyContainer, class MappedContainer>
    flat_multimap(sorted_equivalent_t, Compare, KeyContainer, MappedContainer)
      -> flat_multimap<typename KeyContainer::value_type, typename MappedContainer::value_type,
                       Compare, KeyContainer, MappedContainer>;

  template<class Compare, class KeyContainer, class MappedContainer, class Allocator>
    flat_multimap(sorted_equivalent_t, Compare, KeyContainer, MappedContainer, Allocator)
      -> flat_multimap<typename KeyContainer::value_type, typename MappedContainer::value_type,
                       Compare, KeyContainer, MappedContainer>;
  ...
  template<class InputIterator, class Allocator>
    flat_multimap(InputIterator, InputIterator, Allocator)
      -> flat_multimap<@\exposid{iter-key-type}@<InputIterator>, @\exposid{iter-mapped-type}@<InputIterator>,
                       less<@\exposid{iter-key-type}@<InputIterator>>,
                       vector<@\exposid{iter-key-type}@<InputIterator>,
                              @\exposid{alloc-rebind}@<Allocator, @\exposid{iter-key-type}@<InputIterator>>>,
                       vector<@\exposid{iter-mapped-type}@<InputIterator>,
  ...
  template<class Key, class T, class Allocator = allocator<byte>>
    flat_multimap(initializer_list<pair<Key, T>>, Allocator = Allocator())
      -> flat_multimap<Key, T, less<Key>, vector<Key, @\exposid{alloc-rebind}@<Allocator, Key>>,
                       vector<T, @\exposid{alloc-rebind}@<Allocator, T>>>;

  template<class Key, class T, class Compare, class Allocator = allocator<byte>>
    flat_multimap(Compare, initializer_list<pair<Key, T>>, Allocator = Allocator())
      -> flat_multimap<Key, T, Compare, vector<Key, @\exposid{alloc-rebind}@<Allocator, Key>>,
                       vector<T, @\exposid{alloc-rebind}@<Allocator, T>>>;

  template<class Key, class T, class Allocator = allocator<byte>>
    flat_multimap(sorted_equivalent_t, initializer_list<pair<Key, T>>, Allocator = Allocator())
      -> flat_multimap<Key, T, less<Key>, vector<Key, @\exposid{alloc-rebind}@<Allocator, Key>>,
                       vector<T, @\exposid{alloc-rebind}@<Allocator, T>>>;

  template<class Key, class T, class Compare, class Allocator = allocator<byte>>
    flat_multimap(sorted_equivalent_t, Compare, initializer_list<pair<Key, T>>,
                  Allocator = Allocator())
      -> flat_multimap<Key, T, Compare, vector<Key, @\exposid{alloc-rebind}@<Allocator, Key>>,
                       vector<T, @\exposid{alloc-rebind}@<Allocator, T>>>;
...
\tcode{c.values} with \tcode{std::move(mapped_cont)};
value-initializes \tcode{compare} or
initializes \tcode{compare} with \tcode{comp}, respectively; and
...
template<class Alloc>
  flat_multimap(const key_compare& comp, key_container_type&& key_cont,
                mapped_container_type&& mapped_cont, const Alloc& a);
template<class Alloc>
  flat_multimap(sorted_equivalent_t, const key_compare& comp, const key_container_type& key_cont,
                const mapped_container_type& mapped_cont, const Alloc& a);
template<class Alloc>
  flat_multimap(sorted_equivalent_t, const key_compare& comp, const key_container_type& key_cont,
                mapped_container_type&& mapped_cont, const Alloc& a);
...
namespace std {
  ...
  public:
    ...
    flat_set(sorted_unique_t, container_type cont)
      : @\exposid{c}@(std::move(cont)), @\exposid{compare}@() { }
    flat_set(sorted_unique_t, const key_compare& comp, container_type cont)
    ...
    flat_set(initializer_list<value_type> il)
        : flat_set(il.begin(), il.end()) { }
    flat_set(const key_compare& comp, initializer_list<value_type> il)
        : flat_set(il.begin(), il.end(), comp) { }
    flat_set(sorted_unique_t s, initializer_list<value_type> il)
        : flat_set(s, il.begin(), il.end()) { }
    flat_set(sorted_unique_t s, const key_compare& comp, initializer_list<value_type> il)
    ...
    template<class Alloc>
      flat_set(const key_compare& comp, const container_type& cont, const Alloc& a);
    template<class Alloc>
      flat_set(const key_compare& comp, container_type&& cont, const Alloc& a);
    template<class Alloc>
      flat_set(sorted_unique_t, const container_type& cont, const Alloc& a);
    template<class Alloc>
      flat_set(sorted_unique_t, container_type&& cont, const Alloc& a);
    template<class Alloc>
      flat_set(sorted_unique_t, const key_compare& comp, const container_type& cont,
               const Alloc& a);
    template<class Alloc>
      flat_set(sorted_unique_t, const key_compare& comp, container_type&& cont,
               const Alloc& a);
    ...
    template<class Alloc>
      flat_set(const key_compare& comp, initializer_list<value_type> il, const Alloc& a);
    template<class Alloc>
      flat_set(sorted_unique_t, initializer_list<value_type> il, const Alloc& a);
    template<class Alloc>
      flat_set(sorted_unique_t, const key_compare& comp,
               initializer_list<value_type> il, const Alloc& a);
  ...
  template<class InputIterator, class Compare = less<@\placeholder{iter-value-type}@<InputIterator>>,
    ...
    flat_set(InputIterator, InputIterator, Compare = Compare(), Allocator = Allocator())
      -> flat_set<@\exposid{iter-value-type}@<InputIterator>, Compare,
                  vector<@\exposid{iter-value-type}@<InputIterator>,
                         @\exposid{alloc-rebind}@<Allocator, @\exposid{iter-value-type}@<InputIterator>>>>;

  template<class InputIterator, class Allocator>
    flat_set(InputIterator, InputIterator, Allocator)
      -> flat_set<@\exposid{iter-value-type}@<InputIterator>, less<@\placeholder{iter-value-type}@<InputIterator>>,
                  vector<@\exposid{iter-value-type}@<InputIterator>,
                  @\exposid{alloc-rebind}@<Allocator, @\exposid{iter-value-type}@<InputIterator>>>>;
  ...
  template<class Key, class Compare, class Allocator = allocator<byte>>
    flat_set(Compare, initializer_list<Key>, Allocator = Allocator())
      -> flat_set<Key, Compare,
                  vector<Key, @\exposid{alloc-rebind}@<Allocator, Key>>>;

  template<class Key, class Allocator = allocator<byte>>
    flat_set(initializer_list<Key>, Allocator = Allocator())
      -> flat_set<Key, less<Key>,
                  vector<Key, @\exposid{alloc-rebind}@<Allocator, Key>>>;
...
value-initializes \exposid{compare} or
initializes \exposid{compare} with \tcode{comp}, respectively;
...
\pnum
\effects
Equivalent to \tcode{flat_set(cont)} or \tcode{flat_set(std::move(cont))},
respectively, except that \exposid{c} is constructed with
...
\pnum
\effects
Equivalent to \tcode{flat_set(s, cont)} or \tcode{flat_set(s, std::move(cont))},
respectively, except that \exposid{c} is constructed with
uses-allocator construction\iref{allocator.uses.construction}.
...
template<class Alloc>
  flat_set(sorted_unique_t, const key_compare& comp, const container_type& cont,
           const Alloc& a);
template<class Alloc>
  flat_set(sorted_unique_t, const key_compare& comp, container_type&& cont, const Alloc& a);
template<class InputIterator, class Alloc>
...
namespace std {
  ...
  public:
    ...
    flat_multiset(const key_compare& comp, container_type cont);
    flat_multiset(sorted_equivalent_t, container_type cont)
      : @\exposid{c}@(std::move(cont)), @\exposid{compare}@() { }
    flat_multiset(sorted_equivalent_t, const key_compare& comp, container_type cont)
      : @\exposid{c}@(std::move(cont)), @\exposid{compare}@(comp) { }
    ...
    flat_multiset(initializer_list<value_type> il)
      : flat_multiset(il.begin(), il.end()) { }
    flat_multiset(const key_compare& comp, initializer_list<value_type> il)
      : flat_multiset(il.begin(), il.end(), comp) { }
    flat_multiset(sorted_equivalent_t s, initializer_list<value_type> il)
        : flat_multiset(s, il.begin(), il.end()) { }
    flat_multiset(sorted_equivalent_t s, const key_compare& comp,
                  initializer_list<value_type> il)
    ...
    template<class Alloc>
      flat_multiset(sorted_equivalent_t, container_type&&, const Alloc& a);

    template<class Alloc>
      flat_multiset(const key_compare& comp, const container_type& cont,
                    const Alloc& a);
    template<class Alloc>
      flat_multiset(const key_compare& comp, container_type&& cont,
                    const Alloc& a);
    template<class Alloc>
      flat_multiset(sorted_equivalent_t, const key_compare& comp,
                    const container_type&, const Alloc& a);
    template<class Alloc>
      flat_multiset(sorted_equivalent_t, const key_compare& comp, container_type&&,
                    const Alloc& a);
    ...
    template<class Alloc>
      flat_multiset(const key_compare& comp, initializer_list<value_type> il, const Alloc& a);
    template<class Alloc>
  ...
  template<class InputIterator, class Compare = less<@\exposid{iter-value-type}@<InputIterator>>,
    ...
    flat_multiset(InputIterator, InputIterator, Compare = Compare(), Allocator = Allocator())
      -> flat_multiset<@\exposid{iter-value-type}@<InputIterator>, @\exposid{iter-value-type}@<InputIterator>, Compare,
                       vector<@\exposid{iter-value-type}@<InputIterator>,
                              @\exposid{alloc-rebind}@<Allocator, @\exposid{iter-value-type}@<InputIterator>>>>;

  template<class InputIterator, class Allocator>
    flat_multiset(InputIterator, InputIterator, Allocator)
      -> flat_multiset<@\exposid{iter-value-type}@<InputIterator>, @\exposid{iter-value-type}@<InputIterator>,
                       less<@\exposid{iter-value-type}@<InputIterator>>,
                       vector<@\exposid{iter-value-type}@<InputIterator>,
                              @\exposid{alloc-rebind}@<Allocator, @\exposid{iter-value-type}@<InputIterator>>>>;
  ...
  template<class Key, class Compare = less<Key>, class Allocator = allocator<byte>>
    flat_multiset(initializer_list<Key>, Compare = Compare(), Allocator = Allocator())
      -> flat_multiset<Key, Compare, vector<Key, @\exposid{alloc-rebind}@<Allocator, Key>>>;

  template<class Key, class Compare = less<Key>, class Allocator>
    flat_multiset(initializer_list<Key>, Allocator)
      -> flat_multiset<Key, less<Key>, vector<Key, @\exposid{alloc-rebind}@<Allocator, Key>>>;
...
\pnum
\effects
Equivalent to \tcode{flat_multiset(cont)} or \tcode{flat_multiset(std::move(cont))},
respectively, except that \exposid{c} is constructed with
uses-allocator construction\iref{allocator.uses.construction}.
...
template<class Alloc>
  flat_multiset(sorted_equivalent_t s, container_type&& cont, const Alloc& a);
\end{itemdecl}

\begin{itemdescr}
\pnum
\effects
Equivalent to \tcode{flat_multiset(s, cont)} or \tcode{flat_multiset(s, std::move(cont))},
respectively, except that \exposid{c} is constructed with
uses-allocator construction\iref{allocator.uses.construction}.
...
template<class Alloc>
  flat_multiset(const key_compare& comp, const Alloc& a);
template<class Alloc>
  flat_multiset(const key_compare& comp, const container_type& cont, const Alloc& a);
template<class Alloc>
  flat_multiset(const key_compare& comp, container_type&& cont, const Alloc& a);
template<class Alloc>
  flat_multiset(sorted_equivalent_t, const key_compare& comp,
                const container_type&, const Alloc& a);
template<class Alloc>
