...
\nontermdef{postfix-expression}\br
    ...
    postfix-expression \terminal{\tilde}\br
...
\rSec2[expr.unpack]{Unpacking}

\pnum
\indextext{operator!unpacking}%
\indextext{postfix~\tcode{\~{}}|see{operator, unpacking}}%
A postfix expression followed by a tilde \tcode{\~{}} denotes a value
pack~(\ref{temp.variadic}).
...
\indextext{prefix~\tcode{\~{}}|see{operator, one's~complement}}%
\indextext{operator!increment}%
\indextext{operator!decrement}%
%
\begin{bnf}
